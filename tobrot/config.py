...
class Config(Config):
  TG_BOT_TOKEN = "1553212518:AAFMEEdATxOXyp6aUOuajbnIvrxLgfblzSc"
  APP_ID = 2048409 
  API_HASH = "649e419e5fa739da02b649780d492c1b"
  AUTH_CHANNEL = [-1001437129982]
  INDEX_LINK = "https://up.iunix.workers.dev"
  YTDL_COMMAND = "ytdl@iunixbot"
  LEECH_COMMAND = "leech@iunixbot"
  CLEAR_THUMBNAIL = "clearthumbnail@iunixbot"
  SAVE_THUMBNAIL = "savethumbnail@iunixbot"
  OWNER_ID = 1464067320
...
team_drive = 0AMExHmp8NzCUUk9PVA"""
  ...
  CANCEL_COMMAND_G = "cancel@iunixbot"
  STATUS_COMMAND = "status@iunixbot"
  GET_SIZE_G = "getsize@iunixbot"
  RENEWME_COMMAND = "renewme@iunixbot" 
